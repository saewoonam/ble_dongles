...
void loop()
{
  ...
  else if(cmd_type == configure) // configure radio network and node ID
  {
    ...
    //Serial.print("RegPALevel:");
    //Serial.print((char) radio.readReg(0x11));
    //Serial.print("RegTestPa1:");
    //Serial.print((char) radio.readReg(0x5A));
    //Serial.print("RegTestPa2:");
    //Serial.print((char) radio.readReg(0x5C));
    Serial.print(ACK_CHAR);
    cmd_type = none;
    cmd_len = 0;
  }
